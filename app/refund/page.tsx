      ...
      <div className="bg-neutral-950 ">
        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          ...
          <div>
            ...
            <ul className="list-inside list-disc space-y-4">
              <li>
                You have requested a refund within 30 days of the initial
                payment date.
              </li>
              <li>
                You have provided a valid reason for the refund request, such as
                dissatisfaction with the service quality or failure to deliver
            ...
            <p className="mb-4">
              ...
              <a href="mailto:info@axonstudio.tech">info@axonstudio.tech</a>. We
              will review your request and respond within 3 business days. If
              your refund request is approved, we will issue a refund within 7
            ...
            <p className="mb-4">
              We may update this Refund Policy from time to time. The most
              current version of the policy will always be available on our
              website. By continuing to use our services after any changes to
              the policy, you agree to the updated terms.
            </p>
