          ...
          <div className="grid gap-12 lg:grid-cols-3 lg:gap-8">
            ...
            <div className="flex flex-col items-start gap-8 sm:gap-10 lg:col-span-2">
              <p className="text-neutral-400 text-base sm:text-lg leading-relaxed">
                Welcome to Axon Studio, your premier Software Development firm in Noida. Having successfully launched over 19 projects for our clients in the last 2 years, our team has the expertise to turn your vision into systems that drive unimaginable growth for your business.
              </p>
