...
export function PlaceholdersAndVanishInput({
  ...
  onSubmit: (e: React.FormEvent<HTMLFormElement>, valueSub: string) => void; // Updated onSubmit callback signature
}) {
  ...
  return (
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "font-poppins  w-full relative text-sm sm:text-base z-50 border-none text-gray bg-transparent h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20",
      ...
      <AnimatePresence mode="wait">
        {value === "" && (
          <motion.p
            ...
            className="font-poppins absolute left-4 sm:left-10 top-0 bottom-0 flex items-center z-0 text-zinc-400 text-sm sm:text-base font-normal truncate"
          >
            {submitted ? "Thank you" : placeholders[currentPlaceholder]}
          </motion.p>
        )}
      </AnimatePresence>
    </form>
